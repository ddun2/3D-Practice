...
public class PlayerController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Debug.DrawRay(transform.position + (transform.forward * 0.2f) + (transform.up * 0.01f), new Vector3(0, -1.0f, 0), Color.red);
        Debug.DrawRay(transform.position - (transform.forward * 0.2f) + (transform.up * 0.01f), new Vector3(0, -1.0f, 0), Color.red);
        Debug.DrawRay(transform.position + (transform.right * 0.2f) + (transform.up * 0.01f), new Vector3(0, -1.0f, 0), Color.red);
        Debug.DrawRay(transform.position - (transform.right * 0.2f) + (transform.up * 0.01f), new Vector3(0, -1.0f, 0), Color.red);
    }
